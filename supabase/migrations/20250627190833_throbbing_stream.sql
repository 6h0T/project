/*
  ...
  1. Nuevas Tablas
    ...
    - `banners` - Banners publicitarios creados por usuarios
      - `id` (uuid, primary key)
      ...
      - `image_url` (text)
      - `target_url` (text)
      - `position` (text) - 'top', 'sidebar', 'bottom'
      - `game_category` (text) - categoría del juego
  ...
  2. Seguridad
    ...
    - Políticas para que los usuarios solo puedan ver/editar sus propios datos
*/
