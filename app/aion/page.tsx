...
export default function AionPage() {
  const { premiumServers, normalServers, totalServers, loading, error, refetch } = useServers('aion');
  ...
  if (loading) {
    return (
      <GameLayout
        title="Aion"
        description="Tower of Eternity"
        totalServers={0}
        bgImage="https://images.pexels.com/photos/289586/pexels-photo-289586.jpeg"
