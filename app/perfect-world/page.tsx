...
export default function PerfectWorldPage() {
  const { premiumServers, normalServers, totalServers, loading, error, refetch } = useServers('perfect-world');
  ...
  if (loading) {
    return (
      <GameLayout
        title="Perfect World"
        description="Enter a Perfect World"
        totalServers={0}
        bgImage="https://images.pexels.com/photos/2832382/pexels-photo-2832382.jpeg"
