...
export default function Home() {
  // Usar el hook especializado para Lineage que busca en ambas categorías
  const { premiumServers: apiPremiumServers, normalServers: apiNormalServers, totalServers, loading, error, refetch } = useLineageServers()
  ...
  // ✅ USAR SOLO SERVIDORES REALES DE LA BASE DE DATOS
  const premiumServers = apiPremiumServers
  ...
  return (
    <GameLayout
      title="Lineage II"
      description="The Chronicles Continue"
